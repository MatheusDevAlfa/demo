...
INSERT INTO cycle (name, start_date, end_date, is_active) VALUES ('T9', PARSEDATETIME('01/01/2027', 'dd/MM/yyyy'), PARSEDATETIME('31/03/2027', 'dd/MM/yyyy'), TRUE);

-- =====================================
-- Populando a tabela OBJECTIVE
-- =====================================
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 1', 'Descrição do objetivo 1', FALSE, TRUE, 1);
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 2', 'Descrição do objetivo 2', FALSE, TRUE, 2);
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 3', 'Descrição do objetivo 3', FALSE, TRUE, 3);
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 4', 'Descrição do objetivo 4', FALSE, TRUE, 4);
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 5', 'Descrição do objetivo 5', FALSE, TRUE, 5);
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 6', 'Descrição do objetivo 6', FALSE, TRUE, 6);
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 7', 'Descrição do objetivo 7', FALSE, TRUE, 7);
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 8', 'Descrição do objetivo 8', FALSE, TRUE, 8);
INSERT INTO objective (title, description, is_completed, is_active, team_id) VALUES ('Objetivo 9', 'Descrição do objetivo 9', FALSE, TRUE, 9);

-- =====================================
-- Associando OBJECTIVE e CYCLE (M:N)
-- =====================================
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (1, 1);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (1, 2);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (2, 2);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (2, 3);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (3, 3);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (3, 4);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (4, 4);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (4, 5);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (5, 5);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (5, 6);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (6, 6);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (6, 7);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (7, 7);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (7, 8);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (8, 8);
INSERT INTO objective_cycle (objective_id, cycle_id) VALUES (8, 9);
